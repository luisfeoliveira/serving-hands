...
export function CloseEventButton({ eventId }: { eventId: string }) {
  ...
  if (step === "done") return <EndOfDayOverlay eventId={eventId} />;
          ...
          <div className="bg-background border border-border rounded-2xl shadow-lg p-6 space-y-4 max-w-sm w-full">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Todas as estações serão bloqueadas imediatamente para todos os
                voluntários. Esta ação não pode ser desfeita.
              </p>
            </div>
